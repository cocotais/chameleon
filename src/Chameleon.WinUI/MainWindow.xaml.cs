...
public sealed partial class MainWindow : Window
{
    ...
    private bool BeginMaximizeTransition()
    {
        ...
        DispatcherQueue.TryEnqueue(() =>
        {
            ...
            StartOpacityRevealAnimation(0.92, TimeSpan.FromMilliseconds(115));
        });
    ...
    private bool BeginMinimizedRestoreTransition()
    {
        ...
        {
            ShowWindow(_windowHandle, SwRestore);
            StartWindowStateRevealAnimation(0.985, WindowResizeAnimationDuration);
        });
    ...
    private void BeginWindowStateRevealAnimation(double scaleFrom = 1, TimeSpan? duration = null)
    {
        DispatcherQueue.TryEnqueue(() =>
        {
            StartWindowStateRevealAnimation(scaleFrom, duration);
        });
    }
    ...
    private void BeginOpacityRevealAnimation(double opacityFrom, TimeSpan? duration = null)
    {
        DispatcherQueue.TryEnqueue(() =>
        {
            StartOpacityRevealAnimation(opacityFrom, duration);
        });
    }
    ...
    private static readonly TimeSpan WindowResizeAnimationDuration = TimeSpan.FromMilliseconds(180);
